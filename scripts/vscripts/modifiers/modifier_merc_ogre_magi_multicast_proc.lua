modifier_merc_ogre_magi_multicast_proc = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_merc_ogre_magi_multicast_proc:IsHidden()
	return false
end

function modifier_merc_ogre_magi_multicast_proc:IsDebuff()
	return false
end

function modifier_merc_ogre_magi_multicast_proc:IsStunDebuff()
	return false
end

function modifier_merc_ogre_magi_multicast_proc:IsPurgable()
	return true
end

function modifier_merc_ogre_magi_multicast_proc:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_merc_ogre_magi_multicast_proc:OnCreated( kv )
...
function modifier_merc_ogre_magi_multicast_proc:OnRefresh( kv )
	
end

function modifier_merc_ogre_magi_multicast_proc:OnRemoved()
end

function modifier_merc_ogre_magi_multicast_proc:OnDestroy()
end

--------------------------------------------------------------------------------
-- Interval Effects
function modifier_merc_ogre_magi_multicast_proc:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_merc_ogre_magi_multicast_proc:PlayEffects( value )
	value = value + 1
