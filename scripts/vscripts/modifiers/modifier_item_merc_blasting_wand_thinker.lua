modifier_item_merc_blasting_wand_thinker = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_item_merc_blasting_wand_thinker:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_item_merc_blasting_wand_thinker:OnCreated( kv )
	if IsServer() then
		-- references
...
function modifier_item_merc_blasting_wand_thinker:OnDestroy( kv )
	if IsServer() then
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_item_merc_blasting_wand_thinker:PlayEffects1()
	-- Get Resources
...
function modifier_item_merc_blasting_wand_thinker:PlayEffects2()
	-- Get Resources
	-- local sound_cast = 
...
function modifier_item_merc_blasting_wand_thinker:PlayEffects3( target )
	-- Get Resources
